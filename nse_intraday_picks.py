...
NIFTY200_SYMBOLS = [
    ...
    "TVSMOTOR","UBL","UJJIVAN","ULTRACEMCO","UPL","VOLTAS","WIPRO","YESBANK","ZEEL","TATATECH", "HEXAWARE", "ACMESOLAR", "SUVEN", "GRSE", "TIMEX", "IFCI", "NELCAST", "HLEGLAS",
    "IDBI", "GODFRYPHLP", "DCBBANK", "AXISCADES", "NIRLON", "GREAVESCOT", "SUNFLAG", "DYNAMATECH",
    "BHARATSEAT", "FISCHERVEN", "DCM", "DCMNVL", "DCMSHRIRAM", "DCW", "DECCANCE", "DEEPAKFERT",
    "DEEPAKNTR", "DELTACORP", "DEN", "DENORA", "DHAMPURSUG", "DHANUKA", "DHFL", "DHUNINV",
    "DICIND", "DIGISPICE", "DISHTV", "DIVISLAB", "DIXON", "DLF", "DLINKINDIA", "DMART",
    "DOLAT", "DOLLAR", "DORR-OIL", "DPSCLTD", "DREDGECORP", "DRREDDY", "DSKULKARNI", "DSSL",
    "DTIL", "DYNAMATECH", "ECLERX", "EDELWEISS", "EDUCOMP", "EICHERMOT", "EIDPARRY", "EIHAHOTELS",
    "EIHOTEL", "EIMCOELECO", "EKC", "ELANTAS", "ELECON", "ELECTCAST", "ELECTHERM", "ELGIEQUIP",
    "ELGIRUBCO", "EMAMILTD", "EMAMIPAP", "EMCO", "EMKAY", "EMMBI", "ENDURANCE", "ENIL",
    "EON", "EPL", "EQUITAS", "EQUITASBNK", "ERIS", "ESABINDIA", "ESCORTS", "ESSARSHPNG",
    "ESTER", "EUROTEXIND", "EVEREADY", "EVERESTIND", "EXCEL", "EXCELINDUS", "EXIDEIND", "EXPLEOSOL",
    "EXPOGAS", "FACT", "FAIRCHEM", "FCL", "FDC", "FEDERALBNK", "FEL", "FIBERWEB",
    "FIEMIND", "FILATEX", "FINCABLES", "FINEORG", "FINPIPE", "FLEXITUFF", "FLFL", "FMGOETZE"
]
